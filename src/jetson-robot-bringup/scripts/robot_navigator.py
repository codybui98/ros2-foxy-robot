...
class BasicNavigator(Node):
    ...
    def getResult(self):
        ...
        # elif self.status == GoalStatus.STATUS_ACCEPTED:
        #     return NavigationResult.STATUS_ACCEPTED
        # elif self.status == GoalStatus.STATUS_EXECUTING:
        #     return NavigationResult.STATUS_EXECUTING
        else:
